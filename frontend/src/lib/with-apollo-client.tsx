...
interface WrappedAppComponentConstructor {
  Component?: React.ComponentType;
  router?: RouterProps;
  apolloClient?: ApolloClient<{}>;
}

export interface StatelessAppComponent<P = WrappedAppComponentConstructor>
...
const WrappedApp = (App: StatelessAppComponent) =>
