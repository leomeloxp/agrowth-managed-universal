...
const elevationUmbraMap: string[] = [
  '0px 0px 0px 0px', //  0
  '0px 2px 1px -1px', //  1
  '0px 3px 1px -2px', //  2
  '0px 3px 3px -2px', //  3
...
const elevationPenumbraMap: string[] = [
  '0px 0px 0px 0px', // 0
  '0px 1px 1px 0px', // 1
  '0px 2px 2px 0px', // 2
  '0px 3px 4px 0px', // 3
...
const elevationAmbientMap: string[] = [
  '0px 0px 0px 0px', // 0
  '0px 1px 3px 0px', // 1
  '0px 1px 5px 0px', // 2
  '0px 1px 8px 0px', // 3
...
export const elevation = (dp = 0) => styled.css`
  box-shadow: ${elevationUmbraMap[dp]} rgba(0, 0, 0, 0.2),
    ${elevationPenumbraMap[dp]} rgba(0, 0, 0, 0.12),
    ${elevationAmbientMap[dp]} rgba(0, 0, 0, 0.14);
`;
